  ...
  <body>
    <div id="wrapper">
      ...
      <div id="footer">
          ...
          <input value="凡例表示" type="button" class="lngButton"  onclick="openWindow()" style="margin-left:50px;" />
        </div>
        <table>
          <tr>
            <td id="footLeft">
              <input value="印刷" type="button" class="smlButton"  onclick="submitPrint()" style="margin-left: 70px;" />
            </td>
