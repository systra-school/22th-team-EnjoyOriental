      ...
      <div id="footer">
        <table>
          <tr>
            ...
            <td id="footRight">
              <input value="新規登録" type="button" class="smlButton"  onclick="shiftMstMntRegistInit()" style="float: left;" />
              <input value="更新" type="button" class="smlButton"  onclick="shiftMstMntUpdate()" style="float: left;" />
            </td>
          </tr>
        </table>
      </div>
